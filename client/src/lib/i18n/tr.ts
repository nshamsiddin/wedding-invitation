...
export const tr: Translations = {
  ...
  addToAppleCalendar: 'Apple Takvim',
  addToGoogleCalendar: 'Google Takvim',
  shareInvitation: 'Davetiyeyi paylaş',
  shareCopied: 'Bağlantı kopyalandı',
  shareTitle: 'Davetlisiniz',
  shareText: (couple: string) => `${couple} çiftinin düğününe davetlisiniz.`,
  yourTableLabel: 'Masanız',
  seatingPreferenceNote: 'Düğün salonundaki oturum düzeni için katılım tercihinizi belirtmenizi önemle rica ederiz.',
  nudgeRibbonText: 'Oturum düzenini planlamamıza yardımcı olun — lütfen katılımınızı onaylayın.',
  nudgeRibbonCta: 'Onayla',
  nudgeRibbonDismiss: 'Kapat',
  phonePlaceholder: '+90 555 000 0000',
  preConfirmedOverline: 'Yeriniz ayrıldı',
  preConfirmedHeadline: 'Sizinle kutlamayı sabırsızlıkla bekliyoruz!',
  preConfirmedSub: 'Davetiyeniz onaylandı. Aşağıdaki düğmelerle günü takviminize ekleyebilir, oturum bilginizi görebilir veya yanıtınızı güncelleyebilirsiniz.',
  loadingHint: 'Davetiyeniz hazırlanıyor…',
  invitationOffline: 'Davetiye yüklenemedi',
