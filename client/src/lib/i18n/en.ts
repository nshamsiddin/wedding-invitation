export type Translations = {
  ...
  honorific: string;
  // Assigned table badge label on personal invitations
  tableLabel: string;
  // Navigation
  chapter: string;
...
export const en: Translations = {
  ...
  invitationAlreadyClaimedSub: 'This link has already been used. Please make sure you are using your own personal link.',
